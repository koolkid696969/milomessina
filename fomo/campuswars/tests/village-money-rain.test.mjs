...
const chapters=[{id:'first',joined:60,active:100},{id:'second',joined:34,active:69},{id:'third',joined:21,active:50},{id:'construction',joined:14,active:14},{id:'empty',joined:0,active:60}];
...
test('rain follows actual onboarding ranks, excludes construction even at rank one, and treats ties equally',()=>{
